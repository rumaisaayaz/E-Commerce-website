...
console.log(NEXT_PUBLIC_SANITY_PROJECT_ID,NEXT_PUBLIC_SANITY_AUTH_TOKEN);
...
const targetClient = createClient({
  projectId: "wtw6c45u", // Your Sanity project ID
  dataset: "production", // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "2023-01-01", // Sanity API version
  token:"skErNjCh7xYWADCn5LA9Ri5wQnVF5zjN4ti3Z007nw9K57QImqyCjCRjttBZ4kT41herbOlZ4tn4z5R7cUv93ZQYFltimf20V0ujQ2s6AEhl2vQfnRI9JPImNciCpvP1RMZU7MHznzeBiT3gNzyTdchRiBp5K6OGzqdXkDh1zuvXX27UUib7", // API token for authentication
});
